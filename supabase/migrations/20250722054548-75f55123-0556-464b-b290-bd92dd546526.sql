-- First, make academy_id nullable to allow mock data without foreign key dependencies
ALTER TABLE public.profiles ALTER COLUMN academy_id DROP NOT NULL;

-- Insert 100 mock contacts with all required fields
INSERT INTO public.profiles (
  ...
  ('00000000-0000-0000-0000-000000000001', 'john.smith@email.com', 'John', 'Smith', 'student', '(555) 123-4567', 'Jane Smith', '(555) 123-4568', 'White', 'active', '1985-03-15', '123 Main St', 'Austin', 'TX', '78701', 'Very dedicated student', 'STU001', '1234'),
  ('00000000-0000-0000-0000-000000000002', 'sarah.johnson@email.com', 'Sarah', 'Johnson', 'instructor', '(555) 234-5678', 'Mike Johnson', '(555) 234-5679', 'Black', 'active', '1982-07-22', '456 Oak Ave', 'Austin', 'TX', '78702', 'Senior instructor', 'INS001', '2345'),
  ('00000000-0000-0000-0000-000000000003', 'mike.wilson@email.com', 'Mike', 'Wilson', 'student', '(555) 345-6789', 'Lisa Wilson', '(555) 345-6790', 'Yellow', 'active', '1990-11-08', '789 Pine St', 'Austin', 'TX', '78703', 'Good attendance record', 'STU002', '3456'),
  ('00000000-0000-0000-0000-000000000004', 'emma.davis@email.com', 'Emma', 'Davis', 'student', '(555) 456-7890', 'Robert Davis', '(555) 456-7891', 'Orange', 'inactive', '1995-05-12', '321 Elm Dr', 'Austin', 'TX', '78704', 'On temporary leave', 'STU003', '4567'),
  ('00000000-0000-0000-0000-000000000005', 'james.brown@email.com', 'James', 'Brown', 'admin', '(555) 567-8901', 'Mary Brown', '(555) 567-8902', 'Black', 'active', '1978-09-30', '654 Maple Ln', 'Austin', 'TX', '78705', 'Academy administrator', 'ADM001', '5678'),
  ('00000000-0000-0000-0000-000000000006', 'olivia.jones@email.com', 'Olivia', 'Jones', 'student', '(555) 678-9012', 'David Jones', '(555) 678-9013', 'Green', 'active', '1988-12-25', '987 Cedar St', 'Austin', 'TX', '78706', 'Competes regularly', 'STU004', '6789'),
  ('00000000-0000-0000-0000-000000000007', 'william.garcia@email.com', 'William', 'Garcia', 'student', '(555) 789-0123', 'Maria Garcia', '(555) 789-0124', 'Blue', 'active', '1992-02-14', '147 Birch Rd', 'Austin', 'TX', '78707', 'Team captain', 'STU005', '7890'),
  ('00000000-0000-0000-0000-000000000008', 'ava.martinez@email.com', 'Ava', 'Martinez', 'student', '(555) 890-1234', 'Carlos Martinez', '(555) 890-1235', 'Purple', 'active', '1987-06-18', '258 Willow Way', 'Austin', 'TX', '78708', 'Excellent technique', 'STU006', '8901'),
  ('00000000-0000-0000-0000-000000000009', 'noah.rodriguez@email.com', 'Noah', 'Rodriguez', 'student', '(555) 901-2345', 'Ana Rodriguez', '(555) 901-2346', 'Brown', 'alumni', '1983-10-05', '369 Spruce Ave', 'Austin', 'TX', '78709', 'Former champion', 'STU007', '9012'),
  ('00000000-0000-0000-0000-000000000010', 'sophia.lopez@email.com', 'Sophia', 'Lopez', 'instructor', '(555) 012-3456', 'Juan Lopez', '(555) 012-3457', 'Black', 'active', '1980-04-20', '741 Ash St', 'Austin', 'TX', '78710', 'Kids program leader', 'INS002', '0123');
