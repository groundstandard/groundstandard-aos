-- Create business_config table for non-sensitive organization settings
...
-- Insert sample business configuration data
-- Note: This will only work if organizations exist
INSERT INTO public.business_config (organization_id, key, value)
SELECT 
...
WHERE EXISTS (SELECT 1 FROM public.academies)
