...
-- Update membership_subscriptions table to include all necessary fields (using profile_id)
...
-- Create function to get family members (corrected with actual column names)
