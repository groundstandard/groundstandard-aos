-- Phase 1: Multi-Academy Database Schema Changes (Fixed)
...
-- 3. Create many-to-many relationship table for user-academy memberships
...
-- 4. Create academy switching audit log
...
-- 5. Migrate existing user-academy relationships to new table
...
-- 6. Set last_academy_id to current academy_id for existing users
...
-- 9. Create RLS policies for academy_memberships (CRITICAL for data isolation)
...
-- 10. Create RLS policies for academy_switches (audit trail)
...
-- 11. Create helper functions for multi-academy access control
