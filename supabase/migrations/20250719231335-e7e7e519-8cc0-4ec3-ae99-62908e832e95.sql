-- First, fix the role constraint to include current roles
ALTER TABLE public.profiles 
DROP CONSTRAINT IF EXISTS profiles_role_check;

-- Add new constraint that includes all possible roles (including existing ones)
ALTER TABLE public.profiles 
ADD CONSTRAINT profiles_role_check 
CHECK (role IN ('owner', 'admin', 'staff', 'member', 'student', 'instructor'));

-- Update any existing 'admin' roles to 'owner' (corrected approach)
