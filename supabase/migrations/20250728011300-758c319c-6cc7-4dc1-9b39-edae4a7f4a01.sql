-- Fixed final cleanup of remaining database function security warnings (corrected)
...
-- Fix get_class_enrolled_students function (corrected to use class_reservations table)
