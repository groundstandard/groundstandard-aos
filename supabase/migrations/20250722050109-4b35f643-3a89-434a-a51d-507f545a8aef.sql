-- Simple approach - disable automation triggers temporarily and create test data
...
-- Re-enable triggers for profiles only (skip automation triggers for now)
ALTER TABLE public.profiles ENABLE TRIGGER update_updated_at_column;
ALTER TABLE public.profiles ENABLE TRIGGER audit_role_changes;
ALTER TABLE public.attendance ENABLE TRIGGER process_class_pack_attendance;